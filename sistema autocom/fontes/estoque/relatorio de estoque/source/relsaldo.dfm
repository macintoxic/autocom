object FrmRelSaldo: TFrmRelSaldo
  Left = -1
  Top = 66
  Width = 812
  Height = 480
  ...
  object QrRel: TQuickRep
    ...
    BeforePrint = QrRelBeforePrint
    DataSet = Dm.Tbl_Relatorio
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
    ...
    PrintIfEmpty = True
    ReportTitle = 'Listagem do cadastro de produtos'
    SnapToGrid = True
    Units = MM
    Zoom = 100
    object QRBand1: TQRBand
      ...
      object DescRel: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'RELAT'#211'RIO REFERENTE A TODOS OS PRODUTOS'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clGray
        Font.Height = -11
