...
begin
  try
    ...
    EdCodReferencia.Text := Ds.FieldByName('PRODUTO').AsString;
    ...
    CmbBalanca.ItemIndex := IfThen(Ds.FieldByName('PRODUTODEBALANCA').AsString = 'T',0,1);
...
begin
  case Estado  of
    dsInsert:
      begin
        RunSQL(
          ' INSERT INTO PRODUTO (CODIGOPRODUTO, PRODUTO, NOMEPRODUTO, CODIGOSUBGRUPOPRODUTO, UNIDADE, ' +
          ...
          CmbCasas.Text + ', ' +
          QuotedStr(IfThen(CmbBalanca.ItemIndex = 0,'T','F')) + ', ' +
    ...
    dsEdit:
      begin
        RunSQL(
          ' UPDATE PRODUTO SET ' +
          ' PRODUTO = ' + QuotedStr(EdCodReferencia.Text) + ', ' +
          ...
          ' PRODUTODEBALANCA = ' + IfThen(CmbBalanca.ItemIndex = 0,QuotedStr('T'),QuotedStr('F')) + ', ' +
