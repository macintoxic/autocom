...
begin
     ...
     if i=0 then
        begin
           ...
           if i=-1 then retorno:='.-IMPRESSORA NAO RESPONDE (1) porta '+inttostr(p);
           if i=-2 then retorno:='.-IMPRESSORA NAO RESPONDE (2) porta '+inttostr(p);
...
begin
     i:=now;
     while (now-i)<=strtotime('00:03:00') do // time-out para liberar
        begin
           func:='Espera ECF';
           comando:='30';
...
function Prepara_Resp(tipo:integer;texto,texto2,continue:string):pchar; // esta função prepara a string de retorno da DLL para a aplicação.
var t:string;
...
begin
     ...
     texto2:='@'+texto2;
     if copy(t,1,2)<>'.+' then strpcopy(r,texto) else strpcopy(r,texto2);
     result:=r;
end;
...
//                                                                                                       //
///////////////////////////////////////////////////////////////////////////////////////////////////////////
function Troca_op(tipo,porta:integer;codigo,fazoq:string):pchar;
begin
{========================================================
  tipo -> tipo de ECF
...
function Abrecupom(tipo,porta:integer):pchar;
begin
{========================================================
  tipo -> tipo de ECF
  porta-> porta de comunicação
...
function AbreGaveta(tipo,porta:integer):pchar;
begin
{========================================================
  tipo -> tipo de ECF
  porta-> porta de comunicação
...
function AcreSub(tipo,porta:integer;val,tipacre:string):pchar;
begin
{========================================================
  tipo -> tipo de ECF
  porta-> porta de comunicação
...
function Autentica(tipo,porta:integer;codigo,repete:string):pchar;
begin
{========================================================
  tipo   -> tipo de ECF
  porta  -> porta de comunicação
...
function Cancelacupom(tipo,porta:integer;venda,valor:string):pchar;
begin
{========================================================
  tipo  -> tipo de ECF
  porta -> porta de comunicação
...
function CancItem(tipo,porta:integer;cod,nome,prtot,trib,ind:string):pchar;
begin
{========================================================
  tipo  -> tipo de ECF
  porta -> porta de comunicação
...
function Descitem(tipo,porta:integer; val:string):pchar;
begin
{========================================================
  tipo  -> tipo de ECF
  porta -> porta de comunicação
...
function DescSub(tipo,porta:integer; val:string):pchar;
begin
{========================================================
  tipo  -> tipo de ECF
  porta -> porta de comunicação
...
function FecharCupom(tipo,porta:integer; SegCp,CNFV,l1,l2,l3,l4,l5,l6,l7,l8:string):pchar;
var teste:string;
begin
{========================================================
  tipo   -> tipo de ECF
...
function Finalizadia(tipo,porta:integer):pchar;
begin
{========================================================
  tipo     -> tipo de ECF
  porta    -> porta de comunicação
...
function InicioDia(tipo,porta:integer; verao,op:string):pchar;
begin
{========================================================
  tipo   -> tipo de ECF
  porta  -> porta de comunicação
...
function Lancaitem(tipo,porta:integer; cod, nome, qtde, prunit, prtot, Trib: string):pchar;
var d:string;
begin
{========================================================
  tipo   -> tipo de ECF
...
function Notadecupom(tipo,porta:integer; ind,texto:string):pchar;
begin
{========================================================
  tipo   -> tipo de ECF
  porta  -> porta de comunicação
...
function TextoNF(tipo,porta:integer;texto,valor:string):pchar;
begin
{========================================================
  tipo   -> tipo de ECF
  porta  -> porta de comunicação
...
function Totalizacupom(tipo,porta:integer;Moda,valor:string):pchar;
begin
{========================================================
  tipo   -> tipo de ECF
  porta  -> porta de comunicação
...
function LeituraX(tipo,porta:integer;NF:string):pchar;
begin
{========================================================
  tipo -> tipo de ECF
  porta-> porta de comunicação
...
function Venda_liquida(tipo,porta:integer):Pchar;
begin
{========================================================
  tipo -> tipo de ECF
  porta-> porta de comunicação
...
function COO(tipo,porta:integer;tipo_coo:string):Pchar;
var c:string;
begin
{========================================================
  tipo -> tipo de ECF
...
function Sangria(tipo,porta:integer;modal,valor:string):pchar;
begin
{========================================================
  tipo -> tipo de ECF
  porta-> porta de comunicação
...
function FCX(tipo,porta:integer;modal,valor:string):pchar;
begin
{========================================================
  tipo -> tipo de ECF
  porta-> porta de comunicação
...
function Cheque(tipo,porta:integer;banco,valor,data,favorecido,municipio,cifra,moedas,moedap:string):pchar;
var obs:string;
    dia,mes,ano:word;
     ...
     if ok=true then
        begin
           ...
           if tipo=20 then
              ...
              begin
                 comando:='204074'+valor+'\'+favorecido+'\'+municipio+'\'+data+'\'+enche(obs,' ',1,60);
              end;
...
function Contra_vale(tipo,porta:integer;valor:string):pchar;
begin
{========================================================
  tipo -> tipo de ECF
  porta-> porta de comunicação
...
function ECF_INFO(tipo,porta:integer):pchar;
...
=========================================================}
     ...
     if copy(retorno,1,2)<>'.-' then // se vier um '.-' , significa q ocorreu problema!!
        begin
           ...
           d:=copy(d,1,pos('\',d)-1);
           d:=enche(d,'0',1,4);
           result:=Prepara_Resp(tipo,retorno,d+c+e+f+g,'');
           log(func+' - Recebido (NCR):'+retorno+' ->'+d+c+e+f+g);
...
function LMFD(tipo,porta:integer;inicio,fim:string):pchar;
...
function LMFR(tipo,porta:integer;inicio,fim:string):pchar;
begin
{========================================================
  tipo -> tipo de ECF
  porta-> porta de comunicação
...
function LMMM(tipo,porta:integer;inicio,fim:string):pchar;
begin
{========================================================
  tipo -> tipo de ECF
  porta-> porta de comunicação
