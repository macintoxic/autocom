...
begin
    ...
    NumPessoas := auxdataset.FieldByName('NumPessoas').Value;
...
//            auxdataset.FieldByName('pesoliquido').;
                            ...
                            begin
                                ...
                                GravaFechamentoCupom(
                                    ...
                                    banco, numero_cheque, agencia, conta,
                                        data_pre,
                                    Vendedor,
                                    LeINI(TIPO_TERMINAL, 'ultimocupom'), pedido);
                                DecimalSeparator := ',';
                            end;
                        1:
                            begin //permite troco
