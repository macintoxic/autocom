...
procedure TfrmChequeLeitor.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
    ...
    begin
        ...
        begin
            if
                Application.MessageBox('Erro de Leitura. '#13'Deseja digitar os dados manualmente?', TITULO_MENSAGEM, MB_YESNO + MB_ICONQUESTION) = IDYES then
            begin
