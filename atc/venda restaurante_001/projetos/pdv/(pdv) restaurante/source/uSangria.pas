...
begin
    ...
    if (StrToFloatDef(mskValor.Text, 0) <= 0) then
    begin
            //não aceita mais valores zerados na sangria. Charles 23/10/2003
            Application.MessageBox('O valor para o fundo a sangria deve ser maior que ZERO.',
