...
begin
     (Sender as TCustomEdit).Text := FormatFloat('0000000000',StrToFloatdef((Sender as TCustomEdit).Text,0));
end;

procedure TfrmDadosCheque.mskNumeroDigitoExit(Sender: TObject);
begin
     (Sender as TCustomEdit).Text := FormatFloat('00',StrToFloatdef((Sender as TCustomEdit).Text,0));
end;
