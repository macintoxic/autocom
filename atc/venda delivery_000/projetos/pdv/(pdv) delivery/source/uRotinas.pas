...
interface
uses Controls, Windows, classes, Forms, db, DIALOGS, udmpdv;
...
const
    ...
    TIPO_TERMINAL = 'DELIVERY'; //ALTERAR DE ACORDO COM O TERMINAL. VALORES :  RESTAURANTE, DELIVERY
...
begin
    ...
    with auxDataset do
        dmorc.RunSQL('INSERT INTO PDV_cabecalhocupom ' +
            ...
            {FieldByName('numpessoas').AsString+}  '0,0 )');
    DecimalSeparator := ',';
