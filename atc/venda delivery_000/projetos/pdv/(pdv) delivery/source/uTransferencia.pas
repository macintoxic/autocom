...
var
   auxDataset:TDataSet;
   strAux:string;// armazena o código do pedido para atualiza os itens transferidos.
begin
      if Application.MessageBox( PChar(Format('Confirma a transferência da mesa %3s para a mesa %3s ?',[edOrigem.Text, edDestino.Text])),
      ...
      begin
            ...
            begin
                 ...
                 Application.MessageBox('Mesa de origem inexistente.',TITULO_MENSAGEM,MB_OK + MB_ICONERROR);
            end
                 else
                 begin
                      FreeAndNil(auxDataset);
                      ...
                      if auxDataset.IsEmpty then
                           ...
                           dmORC.RunSQL( 'UPDATE PEDIDOVENDA SET ' +
                             ...
                             begin
                                  ...
                                  dmORC.RunSQL( 'DELETE FROM PEDIDOVENDA WHERE NUMEROPEDIDO = ' + QuotedStr(edOrigem.Text));
