    ...
    DsInsert:
      begin                       
        try
          ...
          Application.MessageBox('Esta pessoa já está cadastrada como cliente!',Autocom,MB_ICONWARNING);
          Abort;
        end;
      end;
    dsEdit:
...
begin
  ...
  try
    ...
    Application.MessageBox('É impossível excluir este fornecedor cliente!',Autocom,MB_ICONWARNING);
    Abort;
  end;  
end;
