...
type
  ...
  procedure RunSQL(strQuery: string; CreateLog: Boolean = False); overload;
  procedure RunSQL(strQuery: string; var aux:TDataSet; CreateLog: Boolean = False); overload;
  ...
  function KeyLookUp(FieldSource, FieldResult, Table, ValueOfField: string): string;
  ...
  procedure ComboGet(Sql: String; Combo: TCustomComboBox);
...
procedure RunSQL(strQuery: string; CreateLog: Boolean = False);
{-------------------------------------------------------------------------------
|  Procedure: RunSQL                                                           |
|  Autor:     Charles                                                          |
|  Data:      26-mar-2003                                                      |
...
procedure RunSQL(strQuery: string; var aux:TDataSet; CreateLog: Boolean = False);
{-------------------------------------------------------------------------------
|  Procedure: RunSQL                                                           |
|  Autor:     Charles                                                          |
|  Data:      26-mar-2003                                                      |
|  Procedure que executa comandos sql que retornam cursores                    |
-------------------------------------------------------------------------------}
begin
     if CreateLog then
      begin
...
{-------------------------------------------------------------------------------
|  Procedure:   ComboGet                                                       |
|  Limpa todos os edits do formulario                                          |
-------------------------------------------------------------------------------}
procedure ClearEdits(Form: TForm);
var
  i: Integer;
...
{-------------------------------------------------------------------------------
|  Procedure:   ComboGet                                                       |
|  Abilita ou Desabilita os componentes do parente enviado                     |
-------------------------------------------------------------------------------}
procedure EnableFields(Status: Boolean; ParentComponent: TWinControl);
var
  i: Integer;
...
function SqlStringTest(Str: String): STring;
begin
  if (IsNull(Str)) or (Str = QuotedStr('')) then
    Result := 'NULL'
  else
    Result := Str;
end;
