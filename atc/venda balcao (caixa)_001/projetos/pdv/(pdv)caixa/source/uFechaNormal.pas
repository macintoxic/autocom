                ...
                if StrToFloat(mskValor.text) > 0 then
                    if Application.messagebox(pchar('Confirma o lancamento de '
                        ...
                        begin
                            ...
                            @TotalizaCupom := GetProcAddress(hand,
                                'Totalizacupom');
...
begin
    ...
    if (TotalPedido - StrToFloat(mskValor.Text) < 0) and
    ...
    begin
        ...
        mskValor.Text := lblFalta.Caption;
        Exit;
    end;
    ...
    begin
        ...
        begin
            ...
            begin
                if StrToIntDef(leini(TIPO_TERMINAL, 'ComprovantePagamento'), 0)
                    = 1 then
                begin
