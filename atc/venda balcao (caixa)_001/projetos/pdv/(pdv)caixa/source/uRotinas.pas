...
interface
uses Controls, Windows, classes, Forms, db, DIALOGS;
...
type
    ...
    FInicioDia         = function(tipo, porta: integer; verao, op, modal: string):shortstring;
    ...
    FLancaitem         = function(tipo, porta: integer; cod, nome, qtde, prunit, prtot, Trib: string): shortstring;
    FTotalizacupom     = function(tipo, porta: integer; Moda, valor: string):shortstring;
    FCancelacupom      = function(tipo, porta: integer; venda, valor: string): shortstring;
    FVenda_liquida     = function(tipo, porta: integer): shortstring;
    FDescSub           = function(tipo, porta: integer; val: string): shortstring;
    FAcreSub           = function(tipo, porta: integer; val, tipacre: string): shortstring;
    ...
    FCheque            = function(tipo, porta: integer; banco, valor, data, favorecido,municipio, cifra, moedas, moedap: string): shortstring;
    ...
    Fcancela_venda_log = function(tipo: integer; terminal, loja: string):ShortString;
...
const
    TITULO_MENSAGEM = 'Sistema Autocom Plus'; // Valor usado nas caixas de mensagem
    TIPO_TERMINAL = 'CAIXA'; //ALTERAR DE ACORDO COM O TERMINAL. VALORES :  RESTAURANTE, DELIVERY, ORCAMENTO
                                   // ou caixa
...
var
    ...
    HandMutex :THandle;
implementation
uses IniFiles, SysUtils, Math, StrUtils,udmPDV;
...
begin
    ...
    with auxDataset do
        dmorc.RunSQL('INSERT INTO PDV_cabecalhocupom ' +
            ...
            IntToStr(FieldByName('numpessoas').AsInteger) + ',0 )');
    DecimalSeparator := ',';
...
begin
    DecimalSeparator := '.';
    dmorc.RunSQL('INSERT INTO PDV_FECHAMENTOCUPOM  ' +
