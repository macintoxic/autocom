...
type
  TfrmImpNotaEntrada = class(TForm)
    QRBand1: TQRBand;
    QRBand2: TQRBand;
    QRBand3: TQRBand;
    QRBand4: TQRBand;
...
var
  frmImpNotaEntrada: TfrmImpNotaEntrada;
...
procedure TfrmImpNotaEntrada.QRDBText2Print(Sender: TObject; var Value: String);
begin
    Value := frmOpcNota.Enche(frmOpcNota.AllTrim(Value), '0', 1, 8);
end;

procedure TfrmImpNotaEntrada.QRDBText3Print(Sender: TObject; var Value: String);
begin
...
procedure TfrmImpNotaEntrada.QRDBText6Print(Sender: TObject; var Value: String);
begin
...
procedure TfrmImpNotaEntrada.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
    if frmOpcNota.tbl_NFEntrada.FieldByName('CANCELADA').AsString = 'T' then
    begin
...
procedure TfrmImpNotaEntrada.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmImpNotaEntrada.QRNotaBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
    db_ValorCanc := 0;
    db_ValorEmit := 0;
