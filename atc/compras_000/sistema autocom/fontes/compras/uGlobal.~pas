...
type
  ...
  procedure SqlRun(SQL: string; Table: TIBQuery; OpenTable: Boolean = True); overload;
  ...
  procedure RunSQL(strQuery: string; IBDatabase: TIBDatabase; var aux:TDataSet; iTipo: Integer); overload;
...
procedure RunSQL(strQuery: string; IBDatabase: TIBDatabase; var aux:TDataSet; iTipo: Integer);
{-------------------------------------------------------------------------------
|  Procedure: RunSQL                                                           |
|  Autor:     Charles                                                          |
|  Data:      26-mar-2003                                                      |
