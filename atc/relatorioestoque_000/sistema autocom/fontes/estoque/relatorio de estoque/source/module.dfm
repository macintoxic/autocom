object Dm: TDm
  ...
  object Tbl_Produto: TIBQuery
    ...
    object Tbl_ProdutoUSUAL: TIBStringField
      FieldName = 'USUAL'
      Origin = 'PRODUTO.USUAL'
      Size = 1
    end
    object Tbl_ProdutoLOTE: TIBStringField
      FieldName = 'LOTE'
      Origin = 'ESTOQUE.LOTE'
      Size = 50
    end
  ...
  object Tbl_Relatorio: TIBQuery
    ...
    SQL.Strings = (
        ...
        'AO, PP.CODPRATELEIRA, PP.CODIGOPRATELEIRA, PP.CODSECAO,E.Lote,P.' +
        'Usual FROM PRODUTO P, ESTOQUE E, GRUPOPRODUTO GP, SUBGRUPOPRODUT' +
        'O SP, SECAO S, PRATELEIRA PP WHERE P.CODIGOPRODUTO = E.CODIGOPRO' +
        'DUTO')
    Left = 336
    Top = 8
    ...
    object Tbl_RelatorioLOTE: TIBStringField
      FieldName = 'LOTE'
      Origin = 'ESTOQUE.LOTE'
      Size = 50
    end
    object Tbl_RelatorioUSUAL: TIBStringField
      FieldName = 'USUAL'
      Origin = 'PRODUTO.USUAL'
      Size = 1
    end
